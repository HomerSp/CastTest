    ...
    public static final class DNSStatefulObjectSemaphore {
        ...
        public void waitForEvent(long timeout) {
            ...
            try {
                ...
                AndroidLogger.w("JmDNS." + getClass().getSimpleName(), "Exception ", exception);
            }
        }
    ...
    public static class DefaultImplementation extends ReentrantLock implements DNSStatefulObject {
            ...
            if (this._task == task) {
                ...
                try {
                    if (this._task == task) {
                        ...
                        AndroidLogger.w("JmDNS." + getClass().getSimpleName(), "Trying to advance state whhen not the owner. owner: " + this._task + " perpetrator: " + task);
                    }
                } finally {
                    this.unlock();
                }
        ...
        public boolean waitForAnnounced(long timeout) {
            ...
            if (!this.isAnnounced()) {
                if (this.willCancel() || this.willClose()) {
                    AndroidLogger.d("JmDNS." + getClass().getSimpleName(), "Wait for announced cancelled: " + this);
                } else {
                    AndroidLogger.w("JmDNS." + getClass().getSimpleName(), "Wait for announced timed out: " + this);
                }
            }
        ...
        public boolean waitForCanceled(long timeout) {
            ...
            if (!this.isCanceled() && !this.willClose()) {
                AndroidLogger.w("JmDNS." + getClass().getSimpleName(), "Wait for canceled timed out: " + this);
            }
