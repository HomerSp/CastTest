        ...
        try {
            ...
            for (Enumeration<NetworkInterface> nifs = NetworkInterface.getNetworkInterfaces(); nifs.hasMoreElements(); ) {
                ...
                for (Enumeration<InetAddress> iaenum = nif.getInetAddresses(); iaenum.hasMoreElements(); ) {
                    ...
                    AndroidLogger.d("JmDNS." + getClass().getSimpleName(), "Found NetworkInterface/InetAddress: " + nif + " -- " + interfaceAddress);
            ...
            AndroidLogger.w("JmDNS." + getClass().getSimpleName(), "Error while fetching network interfaces addresses: " + se);
        }
