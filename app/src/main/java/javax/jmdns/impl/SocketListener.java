...
class SocketListener extends Thread {
    ...
    public void run() {
        try {
            ...
            while (!this._jmDNSImpl.isCanceling() && !this._jmDNSImpl.isCanceled()) {
                ...
                try {
                    ...
                    AndroidLogger.d("JmDNS." + getClass().getSimpleName(), this.getName() + ".run() JmDNS in:" + msg.print(true));
                    if (msg.isQuery()) {
        ...
        AndroidLogger.d("JmDNS." + getClass().getSimpleName(), this.getName() + ".run() exiting.");
    }
