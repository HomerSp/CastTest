        ...
        try {
            ...
            synchronized (this.getDns()) {
                if (this.getDns().isAssociatedWithTask(this, this.getTaskState())) {
                    AndroidLogger.d("JmDNS." + getClass().getSimpleName(), this.getName() + ".run() JmDNS " + this.getTaskDescription() + " " + this.getDns().getName());
            ...
            for (ServiceInfo serviceInfo : this.getDns().getServices().values()) {
                ...
                synchronized (info) {
                    if (info.isAssociatedWithTask(this, this.getTaskState())) {
                        AndroidLogger.d("JmDNS." + getClass().getSimpleName(), this.getName() + ".run() JmDNS " + this.getTaskDescription() + " " + info.getQualifiedName());
            ...
            if (!out.isEmpty()) {
                AndroidLogger.d("JmDNS." + getClass().getSimpleName(), this.getName() + ".run() JmDNS " + this.getTaskDescription() + " #" + this.getTaskState());
