...
public enum DNSRecordType {
    ...
    public static DNSRecordType typeForName(String name) {
        ...
        AndroidLogger.e("JmDNS." + "DNSRecordType", "Could not find record type for name: " + name);
        return TYPE_IGNORE;
    }
    ...
    public static DNSRecordType typeForIndex(int index) {
        ...
        AndroidLogger.e("JmDNS." + "DNSRecordType", "Could not find record type for index: " + index);
        return TYPE_IGNORE;
    }
