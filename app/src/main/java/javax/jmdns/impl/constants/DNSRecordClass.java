...
public enum DNSRecordClass {
    ...
    public static DNSRecordClass classForName(String name) {
        ...
        AndroidLogger.w("JmDNS." + "DNSRecordClass", "Could not find record class for name: " + name);
    ...
    public static DNSRecordClass classForIndex(int index) {
        ...
        AndroidLogger.w("JmDNS." + "DNSRecordClass", "Could not find record class for index: " + index);
        return CLASS_UNKNOWN;
    }
     ...
     *
     * @param indeetClass().getSimpleName()x
