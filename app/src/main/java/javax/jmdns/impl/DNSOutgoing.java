...
public final class DNSOutgoing extends DNSMessage {
     ...
     * @param flags
     * @param multicast
     * @param senderUDPPayload The sender's UDP payload size is the number of bytes of the largest UDP payload that can be reassembled and delivered in the sender's network stack.
     */
